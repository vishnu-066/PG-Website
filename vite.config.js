        ...
        if (req.method === 'POST') {
          ...
          req.on('end', async () => {
            try {
              ...
              const smtpUser = env.SMTP_USER || process.env.SMTP_USER || 'somulavishnu6@gmail.com';
              ...
              if (smtpPass) {
                try {
                  ...
                  console.error('SMTP send error in dev:', smtpErr);
                  ...
                  res.writeHead(400, { 'Content-Type': 'application/json' });
                  return res.end(JSON.stringify({ success: false, message: userFriendlyMsg }));
                }
              }
